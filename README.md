...
***Note: Training the model is optional if model.pkl and feature_columns.pkl are already present.***
...
- Then navigate into the project directory Where the files are saved using `cd`.
